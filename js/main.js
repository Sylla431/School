...
backdrop.addEventListener("click", toggleMenu);
  ...
  menu.addEventListener("click", (event) => {
    ...
    window.innerWidth <= menuCollapseBreakpoint){
      ...
      // if already expanded, collapse it and exit
      if(target.parentElement.classList.contains("active")){
        collapse();
        return;
      }
      // if not expanded run below code
...
/*--------------------
Palette pour changer de theme
------------------------*/
function styleSwitcherToggler(){
  const styleSwitcher = document.querySelector(".js-style-switcher"),
  styleSwitcherToggler = document.querySelector(".js-style-switcher-toggler");
 // styleSwitcherToggler.addEventListener("click", styleSwitcherToggler);
...
themeColorsContainer=document.querySelector(".js-theme-color");
